...
<nav class="navbar sticky-top navbar-light navbar-expand-sm mr-auto" style="color:white;">
    ...
    <div class="collapse navbar-collapse" id="MyCont">
        <div class="navbar-nav mr-auto">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labbeledby="drpdwn">
                    ...
                    <a href="#birth_request" data-toggle="modal" class="dropdown-item">Birth bCard Certificate</a>
        ...
        <form class="form-inline" align="right">`
            <input class="form-control  mr-2" placeholder="Search family" >
...
.</p>
    ...
    <textarea class="form-control" pattern="[A-Za-z]{3,}" id="idea"></textarea>
                              ...
                              <div class="col-md-4 col-sm-5">
                                   <input class="btn btn-success btn-lg" name="submit" type="submit" class="form-control" id="submit" value="   Send   ">
...
<div class="col-sm-4">
  ...
  <div class="form-group" >
    <label class="form-control-label">Contact</label>
      ...
      <input class="form-control" pattern="[0][9][0-9]{10}" type="number" name="ph_no" id="ph_no" placeholder="phone number">
