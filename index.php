...
<nav class="navbar sticky-top navbar-light bg-primary navbar-expand-sm mr-auto" style="color:white;">
    <a class="navbar-brand" href="#" style="color: white;">Choose What to do?</a>
    ...
    <div class="collapse navbar-collapse" id="MyCont">
        <div class="navbar-nav mr-auto">
            ...
            <div class="dropdown">
                <a href="" class="nav-link nav-item dropdown-toggle" data-toggle="dropdown" id="drpdwn" style="color: white;">service</a>
                <div class="dropdown-menu" aria-labbeledby="drpdwn">
                    <a href="#id_request" data-toggle="modal" class="dropdown-item" style="color: black;">Identifation Card</a>
                    <a href="#birth_request" data-toggle="modal" class="dropdown-item" style="color: black;">Birth bCard Certificate</a>
                    <a href="#death_request" data-toggle="modal" class="dropdown-item" style="color: black;">Death Certification</a>
                </div>
            </div>
            <a href="about.html" class="  nav-item nav-link active" style="color: white;">About</a>
        </div>
        <form class="form-inline" align="right">`
            <input class="form-control  mr-2" type="number" id="tur" placeholder="Search family" >
            <button onclick="searching()" class="btn btn-info">Go</button>
        </form>
    </div> <!--container-->
</nav>
...
<header id="header" style="height: 600px; text-align: center;` color:white; background-image: url(img/amazing.jpg);">
  <div class="intro text-center">
    <div class="overlay">
      <div class="container">
        <div class="row" >
            <h1 style="margin-top: 260px;">Welcome to <span class="brand">Kebele Management</span></h1>
...
<div id="services" class="text-center mt-0" style="background-color: black;">
  <div class="container bg-inverse" style="color: white; width: 100%; width: 100%; height: 450px;">
    ...
    <div class="row" style="margin-top: 70px;">
      ...
      <div class="col-xs-6 col-md-3"></i>
        <h4><a href="#death_request" data-toggle="modal">Recording death</a></h4>
        <p>identifing the death that were living in the keble and ....</p>
      </div>
      <div class="col-xs-6 col-md-3"></i>
        <h4><a href="#other">Other services</a></h4>
                ...
                <div class="col-md-7" id="newsletter">
                  <div class="nav justify-content-center flex-column flex-sm-row disp-flex-mac" style="color:white;">
                   <div class="col-md-offset-5 col-md-10 col-sm-12">
                     <div class="wow bounceIn section-title" id="other">
                             <h2 style="margin-top: 100px;" style="color:white;" class="display-4" align="center">give your comment</h2>
                             <p align="center">
    if there is anything wrong with your visitation of this website or any other 
    idea that build us or add for the functionality of this website
    write your email and your idea.
    .</p>
                        </div>
                <div class="wow fadeInUp newsletter-form" data-wow-delay="0.8s">
                    ...
                    <div class="row">
                     <div class="col-md-8 col-sm-7">
                                       <input name="email" type="email" class="form-control" id="emailSend" placeholder="Your Email here">
                                           <div class="form-group">
        <label class="form-control-label">your idea about us</label>
        <textarea class="form-control" pattern="[A-Za-z]{3,}" id="idea" style="height: 400; width: 300;"></textarea>
          ...
          <div class="col-sm-5">
            <div class="nav justify-content-center flex-column flex-sm-row disp-flex-mac" style="color:white;">
                ...
                <div class="mr-auto mb-auto" align="center">
                  <h1 class="display-3">Have you applaid for the service before</h1>
                  <h3>here you can check for its approvence in order to see if you can take or not..</h3>
                </div>

                <input class="form-control  mr-2" type="number" id="Atur" placeholder="your phone number" >
                <button onclick="approving()" class="btn btn-info">Check for approval</button>
            </form>
          </div>
          </div>
       ...
       <div align="center" class="mt-auto" style="background-image: url('images/bg-for-text.png');">
        ...
        <div id="fncs" class="btn-group mb-2 mt-14" aria-label="Kebele's function" align="left"  >
          ...
          <a href="indexAO.php" style="color:white;">Afaan Oromoo</a>
        ...
        <div class="modal-content">
          <form id="death_request_form"  method="POST" action="index.php" >
            ...
            <div class="modal-body mt-0">
                ...
                <p class="bg-success" align="center"  "><span class="btn-danger">Warning:</span> Fill the forms with real information</p>
        ...
        <div class="row">
            <div class="col-sm-6">
              <div class="form-group"   >
                ...
                <input class="form-control" pattern="[A-Za-z]{3,}" type="text" name="fname" id="fname2" placeholder="your name" required id="first name">
                <input class="form-control" pattern="[A-Za-z]{3,}" type="text" name="lname" id="lname2" placeholder="father name" required id="father name">
                <input class="form-control" pattern="[A-Za-z]{3,}" type="text" name="gname" id="gname2" placeholder="grandfather name" required id="grandfather name">
                  ...
                  <div class="col-sm-6"><!-- col-sm-4 no three -->
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-control">
                        <p class="form-control-label">Family ID</p>
    ...
    <div class="modal-dialog" style="max-width:1200px" >
        <div class="modal-content">
          <form  method="POST" id="id_request_form" action="home.php" >
            ...
            <div class="modal-header m-0 pt-0 pb-0">
                <h1 id="head">Identification card form</h1>
            </div>     
<p class="bg-success" align="center"  " style="color: white;">
  <span class="btn-danger">Warning:</span>
   Fill with your real information</p>
            <div class="modal-body mt-0">
...
<div class="col-sm-4">
  <div class="form-group"   >
    ...
    <input class="form-control" pattern="[0][9][0-9]{3,}" type="number" name="h_no" id="h_no" placeholder="House no" required id="house no">
  ...
  <div class="form-group" >
    <label class="form-control-label">Contact</label>
      ...
      <input class="form-control" pattern="[0-9]{8}" type="number" name="ph_no" id="ph_no" placeholder="phone number">
...
<div class="col-sm-4"><!-- col-sm-4 no three -->
  ...
  <div class="form-group">
    ...
    <div class="form-control">
      <p class="form-control-label">Family ID</p>
    <input class="form-control" pattern="[0][9][0-9]{3}" type="number" name="family_id"  placeholder="family id" required id="house no">
    ...
    <div class="modal-dialog" style="max-width:900px" >
        <div class="modal-content">
          <form id="birth_request_form"  method="POST" action="index.php" >
            ...
            <div class="modal-header m-0 pt-0 pb-0">
                <h1 id="head">Birth-date card form</h1>
            </div>     
<p class="bg-success" align="center"  " style="color: white;"><span class="btn-danger">Warning:</span> Fill with your real information</p>
            <div class="modal-body mt-0">
...
<div class="col-sm-6">
  <div class="form-group"   >
    <label class="form-control-label">Name</label>
    <input class="form-control" pattern="[A-Za-z]{3,}" type="text" name="fname" id="fname" placeholder="your name" required id="first name">
    <input class="form-control" pattern="[A-Za-z]{3,}" type="text" name="lname" id="lname" placeholder="father name" required id="father name">
    <input class="form-control" pattern="[A-Za-z]{3,}" type="text" name="gname" id="gname" placeholder="grandfather name" required id="grandfather name">
    <input class="form-control" pattern="[A-Za-z]{3,}" type="text" name="mname" id="mname" placeholder="Mother's full name" required id="mother name">
...
<div class="modal fade" id="abcbirth_request" >
    <div class="modal-dialog" style="max-width:900px" >
        <div class="modal-content">
          <form id="birth_request_form"  method="POST" action="index.php" >
            <div class="modal-title">
