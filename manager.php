    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form  method="POST" action="home.php" >
              ...
              <input class="form-control" pattern="[A-Za-z]{3,}" type="text" name="fname" placeholder="User name">
            </div>
                                <div class="form-group">
                        <label class="form-control-label">mother name</label>
              <input class="form-control" pattern="[A-Za-z]{3,}" type="text" name="mname" placeholder="User name">
            </div>
                                <div class="form-group">
                        <label class="form-control-label">family_id</label>
              <input class="form-control" pattern="[0-9]{4,}" type="number" name="family_id" placeholder="User name">
            </div>
                                <div class="form-group">
                        <label class="form-control-label">member</label>
              <input class="form-control" pattern="[0-9]{2,}" type="number" name="member" placeholder="User name">
            </div>
          </div><!--modal-body-->
                <div class="modal-footer">
